            ...
            <div>
              ...
              <div className={styles.social}>
                <Link href={"https://facebook.com"}>
                  <FaFacebook className={styles.social_item} style={{ fontSize: "24px" }} />
                </Link>
                <Link href={"https://instagram.com"}>
                  <FaSquareInstagram className={styles.social_item} style={{ fontSize: "24px" }} />
                </Link>
                <Link href={"https://t.me"}>
                  <FaTelegram className={styles.social_item} style={{ fontSize: "24px" }} />
                </Link>
              </div>
            </div>
          </div>
